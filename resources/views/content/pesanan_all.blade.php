                            ...
                            @foreach ($pesanan as $pesan)
                                <tr>
                                    ...
                                    <td style="text-align: center">
                                        ...
                                        <a class="btn btn-danger ml-3" href="/delete-pesanan/{{ $pesan->id }}"><i class="fas fa-trash-alt"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" style="text-align: center">
                    <form action="/create-sell" method="POST" enctype="multipart/form-data" autocomplete="off">
                        {{ csrf_field() }}
                        {{-- NO MEJA --}}
    ...
    {{-- edit modal --}}
        ...
        <div class="modal fade" id="editModal-{{$edt->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" style="text-align: center">
                <form action="{{"/pesanan/edit{$edt->id}"}}" method="POST" enctype="multipart/form-data" autocomplete="off">
                    {{ csrf_field() }}
                    {{-- no meja --}}
                    <select class="form-control mt-3" name="no_meja" id="">
